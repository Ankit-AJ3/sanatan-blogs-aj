...
const hi = {
  ...
  comments: {
    ...
    emailLogin: "या ईमेल से लॉगिन / नया खाता बनाएँ",
    errors: {
  ...
  auth: {
    ...
    or: "या",
    name: "आपका नाम",
    namePlaceholder: "जैसे: अंकित शर्मा",
    email: "ईमेल",
    ...
    otpText: (email: string) => `हमने ${email} पर 6 अंकों का कोड भेजा है। वह कोड यहाँ डालें।`,
    otpLabel: "6 अंकों का कोड",
    verify: "सत्यापित करें",
    resend: "कोड फिर से भेजें",
    resendIn: (s: number) => `${s} सेकंड में फिर भेज सकते हैं`,
    resent: "नया कोड भेज दिया गया है।",
    changeEmail: "दूसरा ईमेल इस्तेमाल करें",
    forgotTitle: "पासवर्ड रीसेट करें",
    forgotText: "अपना ईमेल डालें — हम आपको कोड भेजेंगे।",
    sendCode: "कोड भेजें",
    resetTitle: "नया पासवर्ड बनाएँ",
    resetText: (email: string) => `${email} पर भेजा गया कोड और अपना नया पासवर्ड डालें।`,
    resetButton: "पासवर्ड बदलें",
    backToSignIn: "लॉगिन पर वापस जाएँ",
    passwordReset: "पासवर्ड बदल गया। अब नए पासवर्ड से लॉगिन करें।",
    verifyNotice: "आपका ईमेल अभी सत्यापित नहीं है — हमने नया कोड भेजा है।",
    errors: {
      INVALID_EMAIL_OR_PASSWORD: "ईमेल या पासवर्ड ग़लत है।",
      USER_ALREADY_EXISTS: "इस ईमेल से खाता पहले से मौजूद है — लॉगिन करें।",
      INVALID_EMAIL: "ईमेल सही नहीं लग रहा।",
      INVALID_OTP: "कोड ग़लत है। कृपया दोबारा देखें।",
      OTP_EXPIRED: "कोड की अवधि समाप्त हो गई — नया कोड भेजें।",
      TOO_MANY_ATTEMPTS: "बहुत बार ग़लत कोड डाला गया। नया कोड भेजें।",
      PASSWORD_TOO_SHORT: "पासवर्ड कम से कम 8 अक्षरों का होना चाहिए।",
      USER_NOT_FOUND: "इस ईमेल से कोई खाता नहीं मिला।",
...
const en: Dictionary = {
  ...
  comments: {
    ...
    emailLogin: "or log in / sign up with email",
    errors: {
  ...
  auth: {
    ...
    or: "or",
    name: "Your name",
    namePlaceholder: "e.g. Ankit Sharma",
    email: "Email",
    emailPlaceholder: "you@example.com",
    password: "Password",
    ...
    otpText: (email: string) => `We sent a 6-digit code to ${email}. Enter it below.`,
    ...
    forgotText: "Enter your email and we'll send you a code.",
    sendCode: "Send code",
    resetTitle: "Choose a new password",
    resetText: (email: string) => `Enter the code sent to ${email} and your new password.`,
    resetButton: "Change password",
    backToSignIn: "Back to log in",
    passwordReset: "Password changed. Log in with your new password.",
    verifyNotice: "Your email isn't verified yet — we've sent you a new code.",
    errors: {
      ...
      INVALID_OTP: "That code is incorrect. Please check it again.",
  ...
  admin: {
    ...
    newPost: "New article",
    newPostTitle: "Write a new article",
